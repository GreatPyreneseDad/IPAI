...
class Settings(BaseSettings):
    ...
    # Security settings
    SECRET_KEY: str = Field(default_factory=generate_secure_secret_key, description="Secret key for JWT and encryption")
...
def validate_settings(settings: Settings) -> List[str]:
    ...
    if settings.is_production:
        ...
        if os.getenv("SECRET_KEY") is None:
            issues.append("SECRET_KEY should be explicitly set in environment variables for production")
